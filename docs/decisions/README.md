...
| [ADR-0003](0003-normalise-identity-at-the-adapter-boundary.md) | Normalise caller and session identity at the adapter boundary | accepted |
| [ADR-0004](0004-staged-chunk-lifecycle-and-garbage-collection.md) | Collect abandoned staging chunks by event and by sweep, not from the state repository | accepted |
